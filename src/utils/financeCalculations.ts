...
export function calcularCustoFinanceiro(valorBase: number, valorFinal: number): number {
  return valorFinal - valorBase;
}

// Percentual de encargo
export function calcularPercentualEncargo(valorBase: number, valorFinal: number): number {
