...
const ReciboModal: React.FC<ReciboModalProps> = ({
  isOpen,
  onClose,
  titulo,
  tipo,
  ...
  return (
    <Modal open={isOpen} onClose={onClose} title="Recibo de Quitação" size="md">
      <div id="recibo-print-area">
        <div
          className="recibo"
          style={{ padding: '2rem', border: '1px solid hsl(var(--border))', borderRadius: '8px' }}
        >
          <div
            style={{
              display: 'flex',
          ...
          >
            ...
            >
              R${' '}
              {Number(titulo.valor_original).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
            </div>
          </div>
          ...
          >
            <p>
              ...
              <strong>
                {' '}
                R${' '}
                {Number(titulo.valor_original).toLocaleString('pt-BR', {
          ...
          <div
            style={{
              marginTop: '3rem',
              paddingTop: '1.5rem',
              borderTop: '1px dotted hsl(var(--border))',
              fontSize: '0.7rem',
              color: 'hsl(var(--muted-foreground))',
              display: 'flex',
              justifyContent: 'space-between',
