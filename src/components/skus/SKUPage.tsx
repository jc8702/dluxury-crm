...
const CATEGORIAS_TAXONOMIA = [
  ...
  { value: 'FER', label: 'Ferragens (DobradiÁas, CorrediÁas)' },
  { value: 'AC', label: 'AcessÛrios' },
  { value: 'MD', label: 'Madeiras MaciÁas' },
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold tracking-tight uppercase flex items-center gap-2">
              Cat·logo de PeÁas / SKUs
            </h2>
            <p className="text-xs text-muted-foreground mt-1">
              Gerenciamento atÙmico de insumos tÈcnicos e acessÛrios.
            </p>
          </div>
        </div>
        <Button
      ...
      <Card className="p-4">
        <CardContent className="p-0 flex gap-4 items-center">
          <div className="relative flex-1">
            ...
            <Input
              className="pl-10"
              placeholder="Buscar por descriÁ„o, cÛdigo ou categoria..."
              value={searchTerm}
      ...
      >
        <form onSubmit={handleSave} className="flex flex-col gap-5">
          ...
          <div className="relative">
            ...
            <Input
              required
              label="Nome da PeÁa / SKU *"
              className="pl-10"
              placeholder="Ex: DobradiÁa 35mm Click"
              value={formData.nome}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="relative md:col-span-2">
              ...
              <Input
                ...
                label={
                  calcModoChapa
                    ? 'PreÁo Base Final Calculado por M¬≤ (R$) *'
                    : 'PreÁo Base de Custo (R$) *'
                }
            ...
            <div className="mt-2 p-4 bg-muted/10 border border-border rounded-xl space-y-4">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-sm font-semibold text-foreground">
                  Calcular preÁo base a partir do valor da Chapa Inteira
                </span>
              </label>
