...
const StackedBarChart: React.FC<StackedBarChartProps> = ({ data, title }) => {
  ...
  return (
    <div className="card glass" style={{ width: '100%', overflowX: 'auto', padding: '1.5rem' }}>
      {title && (
        <h3 style={{ fontSize: '1.125rem', marginBottom: '1.5rem', fontWeight: 'bold' }}>
          {title}
        </h3>
      )}
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          <div
            style={{ width: '12px', height: '12px', borderRadius: '2px', background: '#28A745' }}
          ></div>
