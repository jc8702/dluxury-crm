            ...
            <div className="max-w-[1600px] mx-auto flex items-center justify-between">
                <div className="flex gap-12">
                    <div className="flex flex-col">
                        ...
                        <span className="text-2xl font-black text-foreground italic">{formatter.format(resumo.custoTotal)}</span>
                    </div>
                    ...
                    <div className="flex flex-col border-l border-border pl-12">
                        ...
                        <div className="flex items-baseline gap-3">
                            <span className="text-2xl font-black text-success italic">{formatter.format(resumo.margemReal)}</span>
