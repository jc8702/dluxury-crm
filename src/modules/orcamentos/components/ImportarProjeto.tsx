                        ...
                        <div className="flex justify-center">
                            ...
                            >
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1">Clique para abrir o importador CutList Bridge / Report</p>
                                </div>
                            </div>
                        </div>
                    )}
                        ...
                        <div className="flex flex-col items-center justify-center py-4 gap-6 animate-in zoom-in-95 duration-300">
                            ...
                            <div className="text-center space-y-2">
                                ...
                                <div className="text-xs text-muted-foreground bg-muted/50 p-4 rounded-lg border border-border text-left space-y-2 min-w-[280px]">
                                    <div className="flex justify-between"><span>Itens:</span> <span className="text-foreground font-bold">{results?.length || 0}</span></div>
                            ...
                            <Button className="w-full bg-primary hover:bg-primary-hover h-12 text-primary-foreground font-bold" onClick={handleConfirmarImportacao} disabled={isAdding}>
