            ...
            <div className="py-6">
                {step === 'save' ? (
                    <div className="text-center space-y-6">
                        ...
                        <div>
                            <h3 className="text-xl font-black text-foreground mb-2 italic">SALVAR E PROSSEGUIR?</h3>
                            <p className="text-muted-foreground">Recomendamos salvar o estado atual do orçamento para que o cliente receba a versão mais recente.</p>
                        </div>
                        <Button 
                    ...
                    <div className="space-y-8">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            >
                                <MessageSquare className={`w-8 h-8 ${method === 'whatsapp' ? 'text-primary' : 'text-muted-foreground'}`} />
                            ...
                            >
                                <Mail className={`w-8 h-8 ${method === 'email' ? 'text-primary' : 'text-muted-foreground'}`} />
                        ...
                        <div className="bg-muted/20 p-6 rounded-3xl border border-border">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <span className="font-black text-xs uppercase tracking-widest text-muted-foreground">Resumo do Envio</span>
                            </div>
                            <div className="space-y-2">
                                <div className="flex justify-between text-sm">
                                    <span className="text-muted-foreground">Cliente:</span>
                                    <span className="text-foreground font-bold">{orcamento.cliente?.nome || 'N/A'}</span>
                                </div>
                                <div className="flex justify-between text-sm">
