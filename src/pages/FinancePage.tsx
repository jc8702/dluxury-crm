...
export default function FinancePage() {
  ...
  return (
    <div className="flex flex-col gap-4 max-w-[1440px] mx-auto w-full animate-fade-in font-body selection:bg-[var(--ui-color-warning-soft)]">
          ...
          <div className="grid grid-cols-12 gap-4 pb-6">
            ...
            <Card className="col-span-12 md:col-span-6 p-6 relative overflow-hidden flex flex-col justify-between group">
              ...
              <div className="flex items-baseline gap-4">
                ...
                <Badge
                  tone={(stats.capital_de_giro || 0) >= 0 ? 'success' : 'danger'}
...
function KPIItem({ label, value, icon: Icon, color, borderColor, desc, colSpan }: any) {
  return (
    <Card className={`col-span-12 ${colSpan} p-6 border-l-4 ${borderColor} group`}>
      <div className="flex justify-between items-start mb-4">
