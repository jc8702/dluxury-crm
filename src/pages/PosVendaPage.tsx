...
const PosVendaPage: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in flex flex-col gap-8">
            ...
            renderRow={(c) => (
              <>
                ...
                <td className="p-4">
                  ...
                  <div className="text-[11px] text-muted-foreground uppercase font-bold">{c.tipo}</div>
                </td>
                <td className="p-4">
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Abrir Novo Chamado de Garantia" size="lg">
        <form onSubmit={handleSave} className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="mb-2 block text-sm font-medium text-foreground/90">Prioridade</label>
