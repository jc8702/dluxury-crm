...
import { Button, Modal, Card, CardContent, CardHeader, CardTitle, Input } from '../design-system/components';
    ...
    <div className="page-container anim-fade-in" style={{ padding: '1rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.75rem' }}>
          ...
          <Button variant="primary" onClick={openNew} style={{ fontSize: '0.85rem' }} aria-label="Nova condição de pagamento">
            <Plus size={16} style={{ marginRight: '0.25rem' }} /> NOVA CONDIÇÃO
          </Button>
        </div>
      </div>
      ...
      <Card style={{ overflow: 'hidden' }}>
        <CardHeader>
          <CardTitle style={{ fontSize: '1rem', fontWeight: 800 }}>Regras de Parcelamento Ativas</CardTitle>
        </CardHeader>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem' }}>
            <div>
              ...
              <Input 
                ...
                value={form.parcelas} 
                onChange={e => setForm({...form, parcelas: Math.max(1, Number(e.target.value))})} 
              />
            </div>
            <div>
