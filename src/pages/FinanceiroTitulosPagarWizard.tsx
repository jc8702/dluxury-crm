...
export default function FinanceiroTitulosPagarWizard() {
  ...
  const renderStep2 = () => (
    <div className="animate-fade-in">
      <h3 style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '1.5rem' }}>Valores e Planejamento</h3>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        <div>
          <label className="label-base">Valor Total da Obrigação</label>
  ...
  const renderStep3 = () => (
    <div className="animate-fade-in">
      <h3 style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '1.5rem' }}>Forma de Parcelamento</h3>
        ...
        {condicoes.map(c => (
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <div style={{ fontWeight: 700, fontSize: '1rem', color: formData.condicao_pagamento_id === c.id ? 'var(--danger)' : 'var(--text)' }}>{c.nome}</div>
    ...
    <div className="animate-fade-in">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
        ...
        <div style={{ marginTop: '1.5rem', padding: '1.25rem', borderTop: '2px dashed var(--border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'var(--surface-hover)', borderRadius: 'var(--radius-md)' }}>
          <span style={{ fontWeight: 700 }}>MONTANTE TOTAL A PAGAR</span>
