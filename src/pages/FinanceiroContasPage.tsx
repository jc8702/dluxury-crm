  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto animate-fade-in pb-20">
      ...
      <Modal
        ...
        title={editing ? 'REVISÃƒO DE CONTA' : 'ABERTURA DE CONTA'}
        size="md"
      >
        <div className="space-y-8 p-4">
          <div className="space-y-1">
            <label className="text-[10px] font-black uppercase tracking-[0.3em] text-primary mb-2 block italic">
              IDENTIFICAÃ‡ÃƒO OPERACIONAL
            </label>
            <Input
              value={form.nome}
              onChange={(e) => setForm({ ...form, nome: e.target.value })}
              placeholder="Ex: ITAÃš EMPRESARIAL"
            />
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="aplicacao">APLICAÃ‡ÃƒO/INVESTIMENTO</option>
                </select>
      ...
      <Modal
        ...
        title="MOVIMENTAÃ‡ÃƒO DE TESOURARIA"
        size="md"
      >
        <div className="space-y-8 p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setTransferForm({ ...transferForm, conta_origem_id: e.target.value })
                }
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setTransferForm({ ...transferForm, conta_destino_id: e.target.value })
                }
              >
                <option value="">SELECIONAR...</option>
                {contas
            ...
            <div className="flex flex-col justify-end">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) =>
                    setTransferForm({ ...transferForm, data_movimento: e.target.value })
                  }
                />
              </div>
            </div>
          ...
          <div>
            <label className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground mb-2 block italic">
              MEMORIAL DESCRITIVO / OBSERVAÃ‡ÃƒO
            </label>
            <Input
              placeholder="EX: REFORÃ‡O DE CAIXA, PAGAMENTO DE TAXAS..."
          ...
          <div className="flex gap-4 pt-4">
            ...
            >
              {transferLoading ? 'PROCESSANDO...' : 'EXECUTAR TRANSFERÃŠNCIA'}
            </Button>
          </div>
        </div>
      </Modal>
              ...
              {[
                ...
                >
                  ...
                  <p className={`text-2xl font-black italic tracking-tighter ${card.color}`}>
                    {card.isNeg ? '- ' : card.value > 0 && i !== 0 && i !== 3 ? '+ ' : ''}
                    {fmt(card.value)}
                  </p>
                </div>
              ))}
            ...
            <div className="flex flex-col xl:flex-row gap-6 items-end bg-muted/20 p-8 rounded-[2.5rem] border border-border">
              ...
              <div className="w-full md:w-64 space-y-2">
                ...
                <div className="relative">
                  ...
                  >
                    <option value="todos">TODOS OS LANÃ‡AMENTOS</option>
                                  ...
                                  onClick={() => {
                                    api.financeiro.conferencia
                                      ...
                                      .then(() => {
                                        ...
                                        const item = newExtrato.extrato.find(
                                          (it) => it.id === m.id,
                                        );
                                        ...
                                        success(
                                          m.conferido
                                            ? 'CONFERÃŠNCIA REVOGADA'
                                            : 'LANÃ‡AMENTO AUDITADO',
                                        );
                                      });
                                  }}
        ...
        <div className="space-y-10 p-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  onChange={(e) =>
                    setFechamentoForm({ ...fechamentoForm, mes: Number(e.target.value) })
                  }
                >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  onChange={(e) =>
                    setFechamentoForm({ ...fechamentoForm, ano: Number(e.target.value) })
                  }
                >
          ...
          <div>
            <h4 className="text-[11px] font-black mb-6 flex items-center gap-3 uppercase tracking-[0.3em] text-muted-foreground italic">
              <Lock className="w-4 h-4 text-primary" /> LINHA DO TEMPO DE SEGURANÃ‡A
            </h4>
                ...
                <tbody className="divide-y divide-border">
                  {fechamentos.length === 0 ? (
                    <tr>
                      ...
                      >
                        Nenhum ciclo fechado identificado
                      </td>
                    </tr>
                  ) : (
                    fechamentos.map((f) => (
                            ...
                            onClick={async () => {
                              ...
                              if (ok)
                                api.financeiro.fechamentos
                                  .save({ ...f, status: 'aberto' })
                                  .then(fetchFechamentos);
                            }}
                          >
                            REABRIR CICLO
                          </button>
