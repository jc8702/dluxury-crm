...
const LandingPage: React.FC = () => {
  ...
  const modulos = [
    ...
    { nome: 'Análise de Margens', desc: 'Cálculo automatizado do markup por cômodo.', icon: Activity },
    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-accent/30 overflow-x-hidden relative">
      ...
      <nav className="relative z-50 flex items-center justify-between px-6 py-4 mx-auto max-w-7xl border-b border-border/20 backdrop-blur-xl bg-background/50 sticky top-0">
        <div className="text-2xl font-black tracking-widest text-transparent bg-clip-text bg-gradient-primary drop-shadow-sm flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-primary flex items-center justify-center text-primary-foreground text-sm">F</div>
          FATTO OS
        </div>
        <div className="hidden md:flex items-center gap-8">
          <a href="#modulos" className="text-sm font-semibold text-muted-foreground hover:text-accent transition-colors">Módulos</a>
          <a href="#precos" className="text-sm font-semibold text-muted-foreground hover:text-accent transition-colors">Preços</a>
      ...
      <header className="relative z-10 flex flex-col items-center justify-center text-center px-4 pt-32 pb-24 mx-auto max-w-5xl">
        ...
        <p className="max-w-2xl text-lg md:text-xl text-muted-foreground leading-relaxed mb-12">
          Do fechamento da venda ao plano de corte, orçamentos automáticos, fluxo de caixa e gestão CNC. Potencialize seu faturamento com a <strong className="text-foreground/80">Inteligência Artificial Integrada</strong>.
        </p>
            ...
            <div className="col-span-1 lg:col-span-3 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="p-5 rounded-xl border border-border/20 bg-background/40 relative overflow-hidden">
                  ...
                  <p className="text-xs font-bold text-muted-foreground tracking-wider mb-2">VENDAS (MÊS)</p>
                ...
                <div className="p-5 rounded-xl border border-border/20 bg-background/40 relative overflow-hidden">
                  ...
                  <p className="text-xs font-bold text-muted-foreground tracking-wider mb-2">ORDENS DE PRODUÇÃO</p>
                ...
                <div className="p-5 rounded-xl border border-border/20 bg-background/40 relative overflow-hidden">
                  ...
                  <p className="text-xs font-bold text-muted-foreground tracking-wider mb-2">APROVEITAMENTO (CORTES)</p>
              ...
              <div className="h-64 rounded-xl border border-border/20 bg-background/40 flex items-center justify-center relative overflow-hidden group-hover:border-border/30 transition-colors">
                ...
                <div className="flex flex-col items-center gap-3 relative z-10">
                  ...
                  <p className="text-sm font-semibold text-muted-foreground">Renderização Gráfica do Plano de Corte 3D</p>
                </div>
              </div>
            </div>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col gap-4">
                  ...
                  <h3 className="text-xl font-bold group-hover:text-accent transition-colors">{m.nome}</h3>
      ...
      {/* ── PLANOS E PREÇOS ── */}
      <section id="precos" className="relative z-10 py-32 px-4 border-t border-border/20 bg-background/80">
        <div className="text-center mb-20 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-black mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
          ...
          <div className="flex flex-col p-8 rounded-3xl border border-border/20 bg-card/50 backdrop-blur-md">
            ...
            <p className="text-sm text-muted-foreground mb-8">Para marceneiros autônomos e pequenas lojas.</p>
            ...
            <ul className="flex flex-col gap-4 text-sm text-foreground/80">
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> CRM & Clientes</li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> Orçamentos Básicos</li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> Agenda de Visitas</li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> Até 2 usuários</li>
            </ul>
          </div>
          ...
          <div className="relative flex flex-col p-8 rounded-3xl border-2 border-accent bg-card/80 backdrop-blur-xl shadow-primary transform md:-translate-y-4">
            ...
            <p className="text-sm text-muted-foreground mb-8">Gestão 360° com Financeiro e Integrações.</p>
            <div className="flex items-end gap-1 mb-8">
            ...
            <ul className="flex flex-col gap-4 text-sm font-medium">
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> Tudo do Plano Basic</li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> Financeiro e Fluxo de Caixa</li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> Inteligência Artificial Dlux</li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> Plano de Corte Integrado</li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> Até 5 usuários simultâneos</li>
            </ul>
          </div>
          ...
          <div className="flex flex-col p-8 rounded-3xl border border-border/20 bg-card/50 backdrop-blur-md">
            ...
            <p className="text-sm text-muted-foreground mb-8">Controle de Indústria e Simulação CNC 3D.</p>
            <div className="flex items-end gap-1 mb-8">
            ...
            <ul className="flex flex-col gap-4 text-sm text-foreground/80">
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> Tudo do Plano PRO</li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> Simulador CNC Tridimensional</li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> Ordens de Produção (OP)</li>
              <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-accent" /> Usuários Ilimitados</li>
            </ul>
          </div>
      ...
      <section id="faq" className="relative z-10 py-32 px-4 max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground">Tire suas dúvidas e veja por que somos o melhor ERP do mercado.</p>
        </div>
      ...
      <footer className="relative z-10 border-t border-border/20 bg-background py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-muted-foreground">&copy; {new Date().getFullYear()} Fatto OS Tecnologias. Todos os direitos reservados.</p>
          </div>
          
          <div className="flex gap-6 text-sm font-semibold">
            <a href="/termos" className="text-muted-foreground hover:text-accent transition-colors">Termos de Uso</a>
            <a href="/privacidade" className="text-muted-foreground hover:text-accent transition-colors">Privacidade</a>
          </div>
        </div>
      </footer>
