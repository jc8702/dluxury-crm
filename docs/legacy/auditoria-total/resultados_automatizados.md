...
- **Arquivos com mais problemas:** src/context/AppContext.tsx, src/modules/orcamentos/_, src/modules/plano-corte/_
...
- src/modules/plano-corte/**tests**/ (otimizadores, serviços)
- src/api-lib/**tests**/ (agentes de IA)
- src/design-system/**tests**/ (componentes de design)
