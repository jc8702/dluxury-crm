...
const regexDimensoes =
  /(?:([a-zA-ZÀ-ÿ0-9\s\-_]{2,})[:\-\s]+)?(\d+(?:[.,]\d+)?)\s*[xX*]\s*(\d+(?:[.,]\d+)?)\s*[xX*]\s*(\d+(?:[.,]\d+)?)/;
const regexTabela =
...
const testCases = [
  ...
  {
    input: 'Base MDF BRANCO 600 x 400 x 15',
    expected: { nome: 'Base MDF BRANCO', l: 600, a: 400, e: 15 },
  },
  {
    input: '001  PRATELEIRA MOVEL  567  530  18  4',
    expected: { nome: 'PRATELEIRA MOVEL', l: 567, a: 530, e: 18, q: 4 },
  },
  { input: 'TAMPO*1200*600*25', expected: { nome: 'TAMPO', l: 1200, a: 600, e: 25 } },
  {
    input: 'Porta Grafite: 600x400x15',
    expected: { nome: 'Porta Grafite', l: 600, a: 400, e: 15, mat: 'GRAFITE' },
  },
];
